<?php
	...
	final class Firewall
	{
		...
		private function createProtectionConfig($configuration)
		{
			$result = [];
			foreach ($configuration['protection'] as $protectionName => $config) {
		...
		{
			return isset($config['active']) && (bool) $config['active'];
		}
